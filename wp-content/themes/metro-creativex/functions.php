...
?>
	...
	?>);"><?php the_title(); ?></h1>
	<div class="insidepost_date"><?php echo get_the_date(); ?> - <?php the_category(', ') ?><?php if(function_exists('the_views')) { echo '&nbsp;&nbsp;&nbsp;&nbsp;'; the_views(); } echo '&nbsp;&nbsp;&nbsp;&nbsp;'; comments_number('暂无评论', '1条评论', '% 评论' ); ?></div>		
<?php
}
